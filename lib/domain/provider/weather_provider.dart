...
import 'package:weather_app/domain/hive/favorite_history/favorite_history.dart';
import 'package:weather_app/domain/hive/favorite_history/hive_boxes.dart';
...
class WeatherProvider extends ChangeNotifier{
 ...
 String setCurrentTime(){
  final getTime = (current?.dt ?? 0) + (weatherData?.timezoneOffset ?? 0); // 1675640500 I've just received it on the debug console
    ...
    try {
      ...
      if(current!.sunset! < current!.dt!){
        if(id >= 200 && id<= 531){
          ...
          AppColors.iconsColor = const Color.fromRGBO(198, 198, 198, 1);
          AppColors.nightTempColor = const Color.fromRGBO(255, 255, 255, 1);
          AppColors.favoriteColor = const Color.fromRGBO(198, 198, 198, 1);
        }
          ...
          AppColors.iconsColor = const Color.fromRGBO(230, 230, 230, 1);
          AppColors.nightTempColor = const Color.fromRGBO(249, 218, 218, 1);
          AppColors.favoriteColor = const Color.fromRGBO(230, 230, 230, 1);
        }
          ...
          AppColors.favoriteColor = const Color(0xFFFFFFFF);
        }
        else if(id == 800){
          ...
          AppColors.nightTempColor = const Color.fromRGBO(81, 218, 255, 1);
          AppColors.iconsColor = const Color.fromRGBO(255, 255, 255, 1);
          AppColors.favoriteColor = const Color.fromRGBO(255, 255, 255, 1); 
        }
          ...
          AppColors.nightTempColor = const Color.fromRGBO(126, 131, 134, 1);
          AppColors.iconsColor = const Color.fromRGBO(226, 226, 226, 1);
          AppColors.favoriteColor = const Color.fromRGBO(226, 226, 226, 1);
        }
        ...
        if(id >= 200 && id<= 531){
          ...
          AppColors.iconsColor = const Color.fromRGBO(3, 7, 8, 1);
          AppColors.nightTempColor = const Color.fromRGBO(0, 44, 37, 1);
          AppColors.favoriteColor = const Color.fromRGBO(3, 7, 8, 1);
        }
        else if(id>= 600 && id<= 622){
          ...
          AppColors.darkBlueColor = const Color.fromRGBO(3, 7, 8, 1);
          AppColors.iconsColor = const Color.fromRGBO(3, 7, 8, 1);
          AppColors.nightTempColor = const Color.fromRGBO(0, 38, 62, 1);
          AppColors.favoriteColor = const Color.fromRGBO(3, 7, 8, 1);
        }
        else if(id>=701 && id<= 781){
          ...
          AppColors.iconsColor = const Color.fromRGBO(50, 50, 50, 1);
          AppColors.nightTempColor = const Color.fromRGBO(216, 216, 216, 1);
          AppColors.favoriteColor = const Color.fromRGBO(50, 50, 50, 1);
        }
        else if(id == 800){
          currentBg = AppBg.shinyDay;
          AppColors.sevenDayBoxColor = const Color.fromRGBO(80, 130, 155, 0.3);
          AppColors.darkBlueColor = const Color.fromRGBO(0, 37, 53, 1);
          AppColors.iconsColor = const Color.fromRGBO(0, 37, 53, 1);
          AppColors.nightTempColor = const Color.fromRGBO(255, 255, 255, 1);
          AppColors.favoriteColor = const Color.fromRGBO(0, 37, 53, 1);
        }
        else if(id >= 801 && id <= 804){
          ...
          AppColors.iconsColor = const Color.fromRGBO(0, 28, 57, 1);
          AppColors.nightTempColor = const Color.fromRGBO(255, 255, 255, 1);
          AppColors.favoriteColor = const Color.fromRGBO(255, 255, 255, 1);
        }
      }
 ...
 void setSevenDays(){
  ...
  for(var i = 0; i<daily.length; i++){
    ...
    if(i==0){ 
      ...
      var itemDate = DateTime.fromMillisecondsSinceEpoch(timeNum); // 2022-01-01 10:00:00.000Z
      date.add(capitalize(DateFormat('EEEE', 'ru').format(itemDate),),); // weekday
    }
  }
...
/*получение иконки для каждого дня недели*/ 
  ...
  String setDailyIcons(int index){
   ...
   String setCurrentSunSet(){
    final getSunSet = (current?.sunset ?? 0) + (weatherData?.timezoneOffset ?? 0);
    final setSunSet = DateTime.fromMillisecondsSinceEpoch(getSunSet * 1000);
   ...
   Future <void> setFavorite(BuildContext context, {String ? cityName })async{
    ...
    box.add(FavoriteHistory(weatherData?.timezone ?? 'Error', currentBg ?? AppBg.shinyDay, AppColors.darkBlueColor.value),).then((value) => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Город $cityName добавлен в избранное'),
    ),
    ),
    );
   }
