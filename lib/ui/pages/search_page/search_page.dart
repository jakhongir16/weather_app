...
import 'package:weather_app/ui/components/search_app_bar/search_app_bar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(image: AssetImage(model.setBg(),),
        fit: BoxFit.cover,
        ),
      ),
      child: Column(
        children: [
          ...
          Align(
            ...
            child: Padding(
              ...
              child: Text('Избранное', style: AppStyle.fontStyle.copyWith(
              fontSize: 16,
